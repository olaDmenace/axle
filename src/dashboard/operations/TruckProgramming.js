...
function TruckProgramming() {
  ...
  const operationalStatus = [
    { oprationalStatusId: 0, operationalStatus: "Truck Programmed" },
    ...
    {
      oprationalStatusId: 12,
      operationalStatus: "Goods Delivered to Customer 1",
    },
    {
      oprationalStatusId: 13,
      operationalStatus: "Goods Delivered to Customer 2",
    },
    {
      oprationalStatusId: 14,
      operationalStatus: "Goods Delivered to Customer 3",
    },
